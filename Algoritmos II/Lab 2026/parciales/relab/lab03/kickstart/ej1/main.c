...
int main(int argc, char *argv[]) {
    ...
    printf("minor historic temp %d \n", minor_historic_temp(table));
    int output[YEARS];
    max_temp_year(table, output);

      max_monthly_rainfall(table, output);
...
/*
 gcc -Wall -Wextra -pedantic -std=c99 -c weather_table.c weather.c weather_utils.c main.c
  gcc -Wall -Wextra -pedantic -std=c99 weather_table.o weather.o weather_utils.o main.o -o weather
 */