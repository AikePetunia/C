...
int main(int argc, char *argv[]) {
    ...
    int player1_points = get_points(battleship_board, player1, MAX_ROUNDS);
    int player2_points = get_points(battleship_board, player2, MAX_ROUNDS);

    printf("Puntos player1: %u Puntos player 2: %u \n", player1_points, player2_points);
