...
#define NR_STOCKS 10 // numero de acciones de empresas
#define NR_COMPANY 4 // numero de empresas que cotizan
#define MAX_FILELINES (NR_STOCKS * NR_COMPANY) // numero de acciones de empresas x numero de empresas que cotizan
